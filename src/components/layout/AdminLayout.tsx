...
const adminNavItems = [
  ...
  { path: '/admin/moments', label: 'Moments', icon: MomentsIcon },
  { path: '/admin/energy', label: 'Energy', icon: EnergyIcon },
  { path: '/admin/wheel', label: 'Wheel', icon: WheelIcon },
  { path: '/admin/poll', label: 'Polls', icon: PollIcon },
  { path: '/admin/qa', label: 'Q&A', icon: QAIcon },
  { path: '/admin/participants', label: 'Participants', icon: ParticipantsIcon },
        ...
        <nav className="flex-1 py-4 px-3 space-y-1 overflow-y-auto">
          {adminNavItems.map((item) => {
            ...
            return (
              ...
              >
                <Icon className={cn('w-5 h-5 flex-shrink-0', isActive ? 'text-accent-600' : '')} />
                <AnimatePresence>
                  {sidebarOpen && (
                    <motion.span
                      initial={{ opacity: 0, width: 0 }}
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 md:px-6 sticky top-0 z-30">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-2 px-3 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors"
            >
